...
logging.basicConfig(filename = "predict__Uni_dataset_rgb_images_with_time.log", level=logging.INFO, format="%(asctime)s: %(levelname)s: %(message)s")
...
def get_args():
    ...
    parser.add_argument("--input", 
                        "-i",
                        default= "/home/deshpand/Thesis/rgb_nir_fusion/densefuse-pytorch/outputs/Uni-dataset_NDVI_ssim_wt_1000000_lr_1e-3/",# "/home/deshpand/noadsm/datasets/Uni-dataset/final_dataset/test/data/rgb",
                        metavar="INPUT", 
                        type=str, 
    ...
    parser.add_argument("--output", 
                        "-o",
                        default="output/NDVI_Uni-dataset_ssim_wt_1000000_lr_1e-3",#"checkpoints/full_uni_dataset_train_30_epochs_2_batch_size_1e-5_lr/test_output_best_model", 
                        metavar="OUTPUT", 
                        required=False, 
                        type=str, 
...
if __name__ == "__main__":
    ...
    for filename in os.listdir(in_files):
        ...
        if not args.no_save:
            ...
            # Make output folder if does not exist already
            os.makedirs(args.output, exist_ok=True)
