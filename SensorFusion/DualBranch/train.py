...
parser.add_argument(
    "--ir_img", default="./data/ir", required=False, help="Where ir images are stored."
)
parser.add_argument(
    "--rgb_img",
    default="./data/rgb",
...
parser.add_argument(
    "--epochs", type=int, default=50, required=False, help="Number of epochs."
)
parser.add_argument(
    "--batch_size", type=int, default=10, required=False, help="Batch size."
)
parser.add_argument(
    "--exp_name",
    type=str,
    default="alpha_1000_beta_1000_gamma_1000",
    required=False,
...
logging.basicConfig(
    level=logging.INFO,
    filename="original_train_V_0.1_log.log",
    filemode="w",
...
def save_regenerated_img(
    torch_tensor, epoch_int, index_int, experiment_name, batch_size
):
    """
    ...
    for iteration in range(epochs):  # This will load the epochs.
        ...
        for index in tqdms:  # This will load the batches.
            ...
            if iteration % 3 == 0 and index == 5:
                save_regenerated_img(
                    img_re, iteration, index, args.exp_name, args.batch_size
                )
            ...
            loss = (
                mse_loss + alpha * grd_loss + beta * std_loss + gamma * perceptual_loss
            )
